...
class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        CreateNeededDirs();
        /*
        ReadGame(DataDirPath() + @"/Game/meincretf.txt");
        ReadDeveloper(DataDirPath() + @"/Developer/moženg.txt");
        ReadPublisher(DataDirPath() + @"/Publisher/EA Sports, it's in the GAME.txt");
